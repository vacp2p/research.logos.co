---
layout: post
name: '[Talk at COSCUP] Logos Research, Waku v2 and Ethereum Messaging'
title: '[Talk at COSCUP] Logos Research, Waku v2 and Ethereum Messaging'
...
Logos Research. Logos Research is an r&d unit doing protocol research focused on creating modular p2p
...
See https://lip.logos.co/ for a full overview.
...
For more on topics, see https://lip.logos.co/waku/informational/23/topics
...
See more here https://lip.logos.co/status/deprecated/waku-usage
