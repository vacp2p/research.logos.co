---
layout: post
name: 'Logos Research - A Rough Overview'
title: 'Logos Research - A Rough Overview'
...
Logos Research is a modular peer-to-peer messaging stack, with a focus on secure messaging. Overview of terms, stack and open problems.

{/* truncate */}

Logos Research is a **modular peer-to-peer messaging stack, with a focus on secure messaging**. What does that mean? Let's unpack it a bit.
