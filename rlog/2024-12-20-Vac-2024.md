---
title: 'Logos Research 2024 Year in Review'
...
In this post, we recap Logos Research's achievements in 2024 and look forward to 2025.

{/* truncate */}

With 2024 now behind us and a new year ahead, 
Logos Research is proud to reflect on the milestones and breakthroughs that defined another year of researching and developing free and open digital public goods for the [Institute of Free Technology](https://free.technology/) and wider web3 ecosystem.

Logos Research comprises various subteams and service units, each with its own focus. 
...
Additionally, the service unit aims to continue building its external reputation through partnerships and publications of relevant work on the [Logos Research forum](https://forum.research.logos.co/).  
...
### Highlights
* DST compute resources transitioned from a hosted environment to a dedicated Logos Research Lab,
...
## Smart Contracts (SC)
Logos Research's Smart Contracts Service Unit ensures the smart contracts deployed across the various IFT portfolio projects are secure, robust, and aligned with project requirements. 
...
## Heading into 2025
This year has seen Logos Research involved with many research, development, and testing undertakings in support of IFT portfolio projects. 
...
We also aim to establish a diverse research community around Logos Research, and our efforts in this regard are already underway. 
In the final quarter of 2024, Logos Research stepped up its collaboration with the libp2p community and made a concerted effort to engage the community on the [Logos Research forum](https://forum.research.logos.co/). 
...
*Follow [Logos Research on X](https://x.com/LogosRnD), join us in the [Logos Research Discord](https://discord.gg/FPSXQ9afJE), or take part in the discussions on the [Logos Research forum](https://forum.research.logos.co/) to stay up to date with our research and development progress.* 
